...
একটি নেস্টেড রুট তৈরি করতে, আপনি একে অপরের ভিতরে ফোল্ডারগুলি নেস্ট করতে পারেন। উদাহরণস্বরূপ, আপনি অ্যাপ ডিরেক্টরিতে দুটি নতুন ফোল্ডার নেস্ট করে একটি নতুন /ড্যাশবোর্ড/সেটিংস রুট যোগ করতে পারেন।

### /ড্যাশবোর্ড/সেটিংস রুট তিনটি সেগমেন্ট নিয়ে গঠিত:

- / (Root segment)
- dashboard (Segment)
- settings (Leaf segment)

## File Conventions (ফাইল কনভেনশন)

### নেস্টেড রুটে নির্দিষ্ট আচরণ সহ UI তৈরি করতে Next.js বিশেষ ফাইলগুলির একটি সেট সরবরাহ করে:

- `layout` একটি সেগমেন্ট এবং এর children দের জন্য শেয়ার করা UI
- `page` একটি রুটের অনন্য UI এবং রুটগুলিকে সর্বজনীনভাবে অ্যাক্সেসযোগ্য করে তোলে
- `loading` একটি সেগমেন্ট এবং এর children দের জন্য UI লোড হচ্ছে
- `not-found` একটি সেগমেন্ট এবং এর children দের জন্য UI পাওয়া যায়নি
- `error` একটি সেগমেন্ট এবং এর children দের জন্য UI ত্রুটি৷
- `global-error` Global Error UI
- `route` সার্ভার-সাইড API এন্ডপয়েন্ট
- `template` বিশেষায়িত re-rendered লেআউট UI
- `default` Parallel রুটের জন্য Fallback UI

```
জেনে রাখা ভালো: .js, .jsx, বা .tsx ফাইল এক্সটেনশন বিশেষ ফাইলের জন্য ব্যবহার করা যেতে পারে।
```

# Component Hierarchy (উপাদান অনুক্রম)

##### একটি রুট সেগমেন্টের বিশেষ ফাইলগুলিতে সংজ্ঞায়িত React উপাদানগুলি একটি নির্দিষ্ট অনুক্রমে রেন্ডার করা হয়:
...
<p align="center">
  <img src="./images/file-conventions-component-hierarchy.avif" alt="NextJs">
</p>

একটি নেস্টেড রুটে, একটি সেগমেন্টের উপাদানগুলি তার মূল সেগমেন্টের উপাদানগুলির মধ্যে নেস্ট করা হবে।

<p align="center">
  <img src="./images/nested-file-conventions-component-hierarchy.avif" alt="NextJs">
</p>

# Colocation (কোলোকেশন)

বিশেষ ফাইলগুলি ছাড়াও, আপনার কাছে অ্যাপ ডিরেক্টরিতে ফোল্ডারগুলির ভিতরে আপনার নিজস্ব ফাইলগুলি (যেমন components, styles, tests, ইত্যাদি) সংযোজন করার বিকল্প রয়েছে

এর কারণ হল যখন ফোল্ডারগুলি রুটগুলি সংজ্ঞায়িত করে, শুধুমাত্র page.js বা route.js দ্বারা প্রত্যাবর্তিত বিষয়বস্তু সর্বজনীনভাবে সম্বোধনযোগ্য

<p align="center">
  <img src="./images/project-organization-colocation.avif" alt="NextJs">
</p>

# Advanced Routing Patterns (উন্নত রাউটিং প্যাটার্নস)

অ্যাপ রাউটার আপনাকে আরও উন্নত রাউটিং প্যাটার্ন বাস্তবায়নে সহায়তা করার জন্য কনভেনশনের একটি সেটও প্রদান করে। এর মধ্যে রয়েছে:

- `Parallel Routes:` আপনাকে একই দৃশ্যে একই সাথে দুই বা ততোধিক পৃষ্ঠা দেখানোর অনুমতি দেয় যা স্বাধীনভাবে নেভিগেট করা যায়। আপনি তাদের নিজস্ব সাব-নেভিগেশন আছে এমন বিভক্ত দৃশ্যের জন্য ব্যবহার করতে পারেন। যেমন ড্যাশবোর্ড

- `Intercepting Routes:` আপনাকে একটি রুট ইন্টারসেপ্ট করতে এবং অন্য রুটের প্রেক্ষাপটে দেখানোর অনুমতি দেয়। বর্তমান পৃষ্ঠার জন্য প্রসঙ্গ রাখা গুরুত্বপূর্ণ হলে আপনি এইগুলি ব্যবহার করতে পারেন। যেমন একটি কাজ সম্পাদনা করার সময় বা একটি ফিডে একটি ফটো প্রসারিত করার সময় সমস্ত কাজ দেখা

এই প্যাটার্নগুলি আপনাকে আরও সমৃদ্ধ এবং আরও জটিল UI তৈরি করতে দেয়, বৈশিষ্ট্যগুলিকে গণতান্ত্রিক করে যা ছোট দল এবং পৃথক বিকাশকারীদের বাস্তবায়নের জন্য ঐতিহাসিকভাবে জটিল ছিল।
